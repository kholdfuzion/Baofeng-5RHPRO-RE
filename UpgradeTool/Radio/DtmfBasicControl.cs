...
public class DtmfBasicControl : UserControl, IViewData
{
    ...
    private void InitializeComponent()
    {
        ...
        this.lblKillCode.Text = "KillCode";
        ...
        this.lblStunCode.Text = "StunCode";
        ...
        this.lblDownCode.Text = "DownCode";
        ...
        this.lblPttidPause.Text = "PTTID Pause";
        ...
        this.lblFirstDigit.Text = "FirstDigit";
        ...
        this.lblPreCarrier.Text = "PreCarrier";
