...
public class ScanBasicControl : UserControl, IViewData
{
    ...
    private void InitializeComponent()
    {
        ...
        this.lblBackTime.Text = "BackTime";
        ...
        this.lblPriorityCh.Text = "PriorityCh";
        ...
        this.lblPriorityScan.Text = "PriorityScan";
        ...
        this.lblScanMode.Text = "ScanMode";
        ...
        this.lblRevertCh.Text = "RevertCh";
