...
public class BasicControl : UserControl, IViewData
{
	...
	private void InitializeComponent()
	{
		...
		this.lblSavingDelay.Text = "省电模式延迟开启时间";
